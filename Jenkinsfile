pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/wellsr2miamioh/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('wellsr2-225')   // <---- Change this to match your kubernetes cluster credentials
    }
